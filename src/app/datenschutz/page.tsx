    ...
    <>
      ...
      <div className="bg-primary text-secondary py-16 sm:py-20">
        <Container>
          ...
          <p className="mt-3 text-secondary/60 text-sm">Privacy Policy</p>
        </Container>
      </div>
          ...
          <article className="max-w-2xl space-y-12">
            ...
            <section>
              ...
              <div className="text-sm text-primary/70 leading-relaxed space-y-3">
                <p>
                  ...
                  Browser-Typ und -Version, verwendetes Betriebssystem, Referrer-URL, Hostname
                  des zugreifenden Rechners sowie Uhrzeit der Serveranfrage.
                </p>
                <p>
                  Diese Daten sind nicht einer bestimmten Person zuordenbar und werden nicht mit
                  Daten aus anderen Quellen zusammengeführt. Rechtsgrundlage für die Verarbeitung
                  ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an dem sicheren und
            ...
            <section>
              ...
              <div className="text-sm text-primary/70 leading-relaxed space-y-3">
                ...
                <p>
                  ...
                  Mit dem Anbieter besteht ein Auftragsverarbeitungsvertrag (AVV) gemäß
                  Art. 28 DSGVO. <Placeholder>AVV-Details oder Link ergänzen, sofern verfügbar</Placeholder>
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-primary/70 leading-relaxed">
                Wenn Sie uns per E-Mail kontaktieren, werden die von Ihnen angegebenen Daten
                (Ihre E-Mail-Adresse sowie der Inhalt Ihrer Nachricht) bei uns gespeichert, um
                Ihre Anfrage zu bearbeiten. Diese Daten geben wir nicht ohne Ihre Einwilligung
                weiter. Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO,
                sofern Ihre Anfrage mit der Erfüllung eines Vertrags zusammenhängt, oder auf
                Grundlage von Art. 6 Abs. 1 lit. f DSGVO aufgrund unseres berechtigten
                Interesses an der effektiven Bearbeitung der an uns gerichteten Anfragen.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-primary/70 leading-relaxed">
                ...
                (Self-Hosting via Next.js Font Optimization). Es findet keine Verbindung zu
                Servern Dritter statt; Google wird bei Seitenaufruf nicht kontaktiert.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="text-sm text-primary/70 leading-relaxed space-y-3">
                <p>
                  Diese Website verwendet keine Tracking-Cookies und keine Dienste zur
                  Webanalyse (z. B. Google Analytics) in der aktuellen Version.
                </p>
                <p>
                  <Placeholder>
                    Sollten künftig Cookies oder Analyse-Dienste eingesetzt werden, diesen
                    Abschnitt ergänzen und ein Cookie-Consent-Banner implementieren.
                  </Placeholder>
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-sm text-primary/70 leading-relaxed space-y-3">
                <p>
                  Diese Website verlinkt auf externe Dienste Dritter (z. B. GitHub, LinkedIn).
                  Beim Aufrufen dieser externen Links gelten die jeweiligen
                  Datenschutzbestimmungen der Anbieter. Wir haben keinen Einfluss auf die
                  Datenverarbeitung durch diese Dienste.
                </p>
                <p>
                  <Placeholder>
                    Weitere externe Dienste oder eingebettete Inhalte hier aufführen, sofern
                    vorhanden (z. B. YouTube-Embeds, Stripe, Calendly).
                  </Placeholder>
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p className="text-sm text-primary/70 leading-relaxed">
                ...
                sie stets den aktuellen rechtlichen Anforderungen zu entsprechen oder um
                Änderungen unserer Leistungen umzusetzen. Es gilt die jeweils aktuelle
                Fassung.
              </p>
